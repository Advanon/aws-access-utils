...
export const getLocalEndpointDynamoDB = (): string =>
  process.env.LOCAL_DYNAMODB_ENDPOINT || DEFAULT_LOCAL_URL_DYNAMODB;

export const getLocalEndpointStepFunctions = (): string =>
  process.env.LOCAL_STEPFUNCTIONS_ENDPOINT || DEFAULT_LOCAL_URL_STEPFUNCTIONS;

export const getLocalEndpointSns = (): string => process.env.LOCAL_SNS_ENDPOINT || DEFAULT_LOCAL_URL_SNS;

export const getLocalEndpointSes = (): string => process.env.LOCAL_SES_ENDPOINT || DEFAULT_LOCAL_URL_SES;
